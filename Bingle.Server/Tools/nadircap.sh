...
if [ -e "$1" ]; then
	...
	echo ImageSize - $image_width x $image_height, $nadircap_size"(NadirSize)""
	...
	convert $input_image -page +0+$gradient_location $temp_grad -flatten -page +0+$nadirball_location $temp_nadir -flatten $input_image
